...
pfname = '../input/RestartLatLon_ne240.cam.h1.0001-01-02-00000.nc'
...
if(NN1 le 3) then begin
  ...
  pfname_out = '../output/ne240/Y_n=0000.nc'
...
;  spawn, 'gzip '+pfname_out
  ...
  pfname_out = '../output/ne240/Y_n=0001.nc'
  spawn, 'rm '+pfname_out+' '+pfname_out+'.gz'
  fid = ncdf_create(pfname_out,/clobber,/netcdf4)
  gpid = ncdf_dimdef(fid,"GridPoint#",ncol)
  mid = ncdf_dimdef(fid,"m",n+1)
...
;  spawn, 'gzip '+pfname_out
  ...
  pfname_out = '../output/ne240/PSI_n=0001.nc'
  spawn, 'rm '+pfname_out+' '+pfname_out+'.gz'
  fid = ncdf_create(pfname_out,/clobber,/netcdf4)
  gpid = ncdf_dimdef(fid,"GridPoint#",ncol)
  mid = ncdf_dimdef(fid,"m",n+1)
...
;  spawn, 'gzip '+pfname_out
  ...
  pfname_out = '../output/ne240/Y_n=0002.nc'
  spawn, 'rm '+pfname_out+' '+pfname_out+'.gz'
  fid = ncdf_create(pfname_out,/clobber,/netcdf4)
  gpid = ncdf_dimdef(fid,"GridPoint#",ncol)
  mid = ncdf_dimdef(fid,"m",n+1)
...
;  spawn, 'gzip '+pfname_out
  ...
  pfname_out = '../output/ne240/PSI_n=0002.nc'
  spawn, 'rm '+pfname_out+' '+pfname_out+'.gz'
  fid = ncdf_create(pfname_out,/clobber,/netcdf4)
  gpid = ncdf_dimdef(fid,"GridPoint#",ncol)
  mid = ncdf_dimdef(fid,"m",n+1)
...
;  spawn, 'gzip '+pfname_out
  ...
  ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ; Y
  pfname_in = '../output/ne240/Y_n='+string(n,form=fm)+'.nc'
...
;  spawn, 'gzip '+pfname_in
  ...
  ;;;;;;;;;;;;;;;;;;;;;
  ; PSI
  pfname_in = '../output/ne240/PSI_n='+string(n,form=fm)+'.nc'
  spawn, 'gunzip '+pfname_in+'.gz'
  fid_in = ncdf_open(pfname_in)
...
for n = max([NN1,3]), NN2 do begin
  ...
  pfname_out = '../output/ne240/Y_n='+string(n,form=fm)+'.nc'
  spawn, 'rm '+pfname_out+' '+pfname_out+'.gz'
  fid = ncdf_create(pfname_out,/clobber,/netcdf4)
  gpid = ncdf_dimdef(fid,"GridPoint#",ncol)
  mid = ncdf_dimdef(fid,"m",n+1)
...
;  spawn, 'gzip '+pfname_out
  ...
  pfname_out = '../output/ne240/PSI_n='+string(n,form=fm)+'.nc'
  spawn, 'rm '+pfname_out+' '+pfname_out+'.gz'
  fid = ncdf_create(pfname_out,/clobber,/netcdf4)
  gpid = ncdf_dimdef(fid,"GridPoint#",ncol)
  mid = ncdf_dimdef(fid,"m",n+1)
